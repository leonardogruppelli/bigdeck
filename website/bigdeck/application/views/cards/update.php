        ...
        <div class="block primary">
            <div class="col full col-12">
                <div class="col full col-sm-8 col-10">
                    <h1 class="title normal">Card Update</h1>
                </div>
            ...
            <form class="row" action="<?php echo base_url('cards/update/' . $card->id); ?>" enctype="multipart/form-data" method="post">
                <div class="col col-xsm-12 col-sm-12 col-md-6 col-6">
                    <div class="input">
                        <label for="name" class="text small">Name</label>
                        <input type="text" name="name" id="name" class="text small" value="<?php echo $card->name; ?>" required>
                    </div>
                </div>
                <div class="col col-xsm-12 col-sm-12 col-md-6 col-6">
                    <div class="input">
                        <label for="cost" class="text small">Cost</label>
                        <input type="text" name="cost" id="cost" class="text small" value="<?php echo $card->cost; ?>" required>
                    </div>
                </div>
                <div class="col col-xsm-12 col-sm-12 col-md-6 col-6">
                    <div class="input">
                        ...
                        <select name="rarity_id" id="rarity_id" class="text small" required>
                            ...
                            <?php foreach($rarities AS $rarity) { ?>
                                <option value="<?php echo $rarity->id; ?>" <?php echo ($rarity->id == $card->rarity_id ? 'selected' : ''); ?>><?php echo $rarity->name; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="input">
                        ...
                        <select name="type_id" id="type_id" class="text small" required>
                            ...
                            <?php foreach($types AS $type) { ?>
                                <option value="<?php echo $type->id; ?>" <?php echo ($type->id == $card->type_id ? 'selected' : ''); ?>><?php echo $type->name; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="input">
                        ...
                        <select name="race_id" id="race_id" class="text small" required>
                            ...
                            <?php foreach($races AS $race) { ?>
                                <option value="<?php echo $race->id; ?>" <?php echo ($race->id == $card->race_id ? 'selected' : ''); ?>><?php echo $race->name; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="input">
                        ...
                        <select name="class_id" id="class_id" class="text small" required>
                            ...
                            <?php foreach($classes AS $class) { ?>
                                <option value="<?php echo $class->id; ?>" <?php echo ($class->id == $card->class_id ? 'selected' : ''); ?>><?php echo $class->name; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
